...
def main ():
	...
	game_filter = [[x, all([input_data[x]['IsCompleted'], (input_data[x]['HomeScore'] is not None), (input_data[x]['AwayScore'] is not None), (input_data[x]['HomeID'] is not None), (input_data[x]['AwayID'] is not None), (input_data[x]['HomeName'] is not None), (input_data[x]['AwayName'] is not None), (input_data[x]['IsNeutralSite'] is not None), (input_data[x]['Season'] is not None), ((input_data[x]['Year'] is not None) and (input_data[x]['Month'] is not None) and (input_data[x]['Day'] is not None) and (datetime.date(int(str(input_data[x]['Year']).strip()), int(str(input_data[x]['Month']).strip()), int(str(input_data[x]['Day']).strip())) <= final_date_to_rank)), ((input_data[x]['Season'] is not None) and (int(input_data[x]['Season']) >= earliest_season) and (int(input_data[x]['Season']) <= season_to_rank))])] for x in input_data.keys()]
	unplayed_game_filter = [[x, all([not input_data[x]['IsCompleted'], (input_data[x]['HomeID'] is not None), (input_data[x]['AwayID'] is not None), (input_data[x]['HomeName'] is not None), (input_data[x]['AwayName'] is not None), (input_data[x]['IsNeutralSite'] is not None), (input_data[x]['Season'] is not None), ((input_data[x]['Year'] is not None) and (input_data[x]['Month'] is not None) and (input_data[x]['Day'] is not None)), ((input_data[x]['Season'] is not None) and (int(input_data[x]['Season']) >= season_to_rank))])] for x in input_data.keys()]
